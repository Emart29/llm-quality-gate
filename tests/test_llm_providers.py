...
class TestLLMFactory:
    ...
    def test_create_all_providers(self, comprehensive_config):
        ...
        for provider_name in LLMFactory.PROVIDERS.keys():
            try:
                provider = LLMFactory.create_provider(provider_name, comprehensive_config)
                assert provider.provider_name == provider_name
            except Exception as e:
                # Local providers might fail without servers running
    ...
    def test_role_based_providers(self, comprehensive_config):
        ...
        generator = LLMFactory.create_provider_for_role("generator", comprehensive_config)
        judge = LLMFactory.create_provider_for_role("judge", comprehensive_config)
